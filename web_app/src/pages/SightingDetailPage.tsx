...
import { ArrowLeft, Camera, CheckCircle, Clock, MapPin, Maximize2, Scale, ScanFace, ShieldCheck, X, XCircle } from 'lucide-react';
...
export const SightingDetailPage: React.FC = () => {
  ...
  return (
    <div className="main-content">
      ...
      <div className="glass-panel comparison-card"><h3 className="subsection-title"><ScanFace size={18} aria-hidden="true" /> {t.sighting.faceComparison}</h3><div className="comparison-grid">
